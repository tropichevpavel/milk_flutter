...
class api {
	...
	static getProds() => doRequest('$apiURL/prods', GET);
	static getProds4Order() => doRequest('$apiURL/prods/toSell', GET);
	static getProdUnits(int id) => doRequest('$apiURL/prods/$id/units', GET);
	...
	static getUnits() => doRequest('$apiURL/units', GET);
