...
import 'package:milk/utils/api.dart';
...
class _MainPageState extends State<MainPage> {
      ...
      body: Container(
        ...
        child: GridView(
          ...
          children: [
            ...
            mainMenuButton('/orders', 'Заказы', Icons.airport_shuttle)
          ],
        ),
      )
    );
  ...
  Widget mainMenuButton(String route, String title, IconData icon) => ElevatedButton(
